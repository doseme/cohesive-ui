...
export const colors: IColor[] = [
  ...
  { name: 'ADE', color: ADE },
  { name: 'SUBTHERAPEUTIC', color: SUBTHERAPEUTIC },
  { name: 'SEE', color: SEE },
  { name: 'INRANGE', color: INRANGE },
  { name: 'WARNING', color: WARNING },
  { name: 'FOOTER_BLACK', color: FOOTER_BLACK },
  { name: 'FOOTER_LINK', color: FOOTER_LINK },
  { name: 'FOOTER_HOVER', color: FOOTER_HOVER },
  { name: 'BG_WHITE', color: BG_WHITE },
  { name: 'VALID_GREEN', color: VALID_GREEN },
  { name: 'INVALID_RED', color: INVALID_RED },
  { name: 'SHADOW', color: SHADOW },
