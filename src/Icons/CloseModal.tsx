    ...
    <svg width="33" height="34" viewBox="0 0 33 34" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="X-close/close-modal-icon">
        <g id="X close icon" filter="url(#filter0_d)">
          <path id="Rectangle Copy 4" fill-rule="evenodd" clip-rule="evenodd" d="M5.30499 24.7505L24.7504 5.30502L26.695 7.24957L7.24954 26.695L5.30499 24.7505Z" fill="white" />
          <path id="Rectangle Copy 5" fill-rule="evenodd" clip-rule="evenodd" d="M7.24951 5.30502L26.6949 24.7505L24.7504 26.695L5.30497 7.24957L7.24951 5.30502Z" fill="white" />
        </g>
      </g>
      <defs>
